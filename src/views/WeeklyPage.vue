    ...
    <div class="table">
        <div class="container">
            ...
            <el-table :data="data" border style="width: 100%" ref="multipleTable" height="500px">
                ...
                <el-table-column label="创建日期" prop="create_time" :formatter="formatDate" width="300"
                    ...
                    <el-tabs v-model="activeName1" @tab-click="handleClick1">
                        <el-tab-pane label="参会情况" name="first1">
                            <el-descriptions title="专题会" :column="1" :size="size">
                                <el-descriptions-item v-for="item in meetingTopic" :key="item.label"
                                                      :value="item.value">
                                    {{item.meeting_detail}}
                            ...
                            <el-descriptions title="科务会" :column="1" :size="size">
                                <el-descriptions-item v-for="item in meetingAffairs" :key="item.label"
                                                      :value="item.value">
                                    {{item.meeting_detail}}
                                </el-descriptions-item>
        ...
        <el-dialog title=" 周报填写" v-model="setVisible" width="850px">
            <el-tabs type="border-card" v-model="activeName" @tab-click="handleClick">
                                            ...
                                            <el-row :gutter="20" class="margins">
                                                <el-col :span="18">
                                                    <el-input type="textarea" autosize
                                                              v-model="list.meeting_detail"></el-input>
                                                </el-col>
                                                <el-col :span="6">
                            ...
                            <el-descriptions title="科室日常工作" :column="1" :size="20">
                                <el-descriptions-item v-for="item in normalWork" :key="item.label" :value="item.value">
                                    <el-input type="textarea" :autosize="{ minRows: 3, maxRows: 5}"
                                              v-model="item.normal_work"></el-input>
                                </el-descriptions-item>
                            </el-descriptions>
                            ...
                            <el-descriptions title="绿通业务" :column="1" :size="20">
                                <el-descriptions-item v-for="item in lvtong" :key="item.label" :value="item.value">
                                    <el-input type="textarea" :autosize="{ minRows: 2, maxRows: 4}"
                                              v-model="item.lvtong_work"></el-input>
                                </el-descriptions-item>
                            </el-descriptions>
                        </el-tab-pane>
                        <el-tab-pane label="其他重点工作" name="fourth1">
                                    ...
                                    <el-row>
                                        <el-col :span="24" v-for="(list,index) in other" :key="list">
                                            <el-row :gutter="20" class="margins">
                                                <el-col :span="18">
                                                    <el-input type="textarea" autosize
                                                              v-model="list.other_work"></el-input>
                                                </el-col>
                                                <el-col :span="6">
                ...
                <el-tab-pane label="需研究事项" name="third">
                    <el-descriptions title="需研究事项" :column="1" :size="20">
                        <el-descriptions-item>
                            <el-input type="textarea" autosize v-model="research"></el-input>
                        </el-descriptions-item>
                    </el-descriptions>
                </el-tab-pane>
            </el-tabs>
        ...
        methods: {
            ...
            handleSetDetail(row) {
                ...
                WeeklyManager.getWeeklyDetail(this.form).then((res) => {
                    ...
                    this.research = (this.tableDetail.research === '' || this.tableDetail.research === null ? '' : this.tableDetail.research.normal_work)
