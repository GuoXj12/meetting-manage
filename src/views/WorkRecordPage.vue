  ...
  <div class="table">
    <div class="container">
      ...
      <el-table :data="data" border style="width: 100%" ref="multipleTable" height="638px">
        ...
        <el-table-column label="工作事项" prop="work_topic" min-width="200" align="center"></el-table-column>
    ...
    <el-dialog title="添加工作事项" v-model="centerDialogVisible" width="650px" center>
      <el-form :model="registerForm" status-icon :rules="rules" ref="registerForm" label-width="100px"
        ...
        <el-form-item label="工作事项：" prop="work_topic">
          <el-input type="textarea" placeholder="工作事项" v-model="registerForm.work_topic"></el-input>
        </el-form-item>
    ...
    <el-dialog title="会议编辑" v-model="editVisible" width="650px">
      <el-form ref="form" :model="form" label-width="100px">
        ...
        <el-form-item label="工作事项：">
          <el-input type="textarea" v-model="form.work_topic"></el-input>
        </el-form-item>
...
export default {
  ...
  methods: {
    ...
    deleteRow() {
      WorkRecordManager.deleteWork(this.idx)
          .then(res => {
            if (res) {
              this.getData()
              this.$notify({
